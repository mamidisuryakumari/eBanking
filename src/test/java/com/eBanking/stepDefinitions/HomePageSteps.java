...
public class HomePageSteps{
	...
	public void iGoToHomePage() {
		try {
			...
			logger.error("An exception error occured while navigating to home page" ,e.getMessage());
			throw e;
		}
	...
	public void user_is_on_the_home_page() {
		try {
			...
			logger.info(" Title matched for the home page");
		} catch (AssertionError e) {
			logger.error("Title is not matched for home page", e.getMessage());
			throw e;
		} catch (Exception e) {
			logger.error("An unexcepted error occured while matching the title" , e);
			throw e;
		}
